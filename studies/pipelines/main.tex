...
%TODO Guide students through the process by asking them to:
%       - Provide link to Sahara example diagrams and have tutor summarise at start of session
%       - produce a context diagram in first 5 min
%       - discuss options and produce a container diagram in next 15 min and present (5 min)
%       - discuss options and produce a component diagram in next 15 min and present (5 min)
...
\teacher{
  Make the comment that we don't expect them to implement the architecture each week.
  This one is fairly quick and easy and it's only week 2, so in theory they have time to spend on it.
}
