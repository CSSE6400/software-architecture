...
\title{TicketOverflow}
\author{Millie Hughes \& Richard Thomas}
...
\paragraph{Task}
You are working for TicketOverflow, a new competitor in the online ticket booking space.
...
At the scale that Ticket\-Overflow hopes to operate,
...
Taylor Swift has chosen TicketOverflow for the release of her \textit{Post} Eras Tour.
