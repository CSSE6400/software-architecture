...
%    \animategraphics[loop,autoplay,width=\linewidth]{10}{diagrams/recreate/fnum}{1}{20}
...
\begin{frame}{Recreate Deployment}
    ...
    \end{columns}
\end{frame}
\note{Renewed state means app is reinitialised and db is consistent with system version.}
...
\begin{frame}{Rolling Deployment \cite{deployment-strategies}}
    ...
    % \animategraphics output only works in Adobe Acrobat.
    % Replace with \includegraphics of the merged image.
%    \animategraphics[loop,autoplay,width=\linewidth]{10}{diagrams/rolling/fnum}{1}{27}
...
\begin{frame}{Blue-Green Deployment \cite{deployment-strategies}}
    ...
    % \animategraphics output only works in Adobe Acrobat.
    % Replace with \includegraphics of the merged image.
%    \animategraphics[loop,autoplay,width=\linewidth]{10}{diagrams/blue-green/fnum}{1}{14}
...
\begin{frame}{Canary Deployment \cite{deployment-strategies}}
    ...
    % \animategraphics output only works in Adobe Acrobat.
    % Replace with \includegraphics of the merged image.
%    \animategraphics[loop,autoplay,width=\linewidth]{10}{diagrams/canary/fnum}{1}{15}
...
\begin{frame}{A/B Deployment \cite{deployment-strategies}}
    ...
    % \animategraphics output only works in Adobe Acrobat.
    % Replace with \includegraphics of the merged image.
%    \animategraphics[loop,autoplay,width=\linewidth]{10}{diagrams/a-b/fnum}{1}{19}
...
\note[itemize]{
    ...
    \item Deploy the version that has best usage result.
}
...
\begin{frame}{Shadow Deployment \cite{deployment-strategies}}
    ...
    % \animategraphics output only works in Adobe Acrobat.
    % Replace with \includegraphics of the merged image.
%    \animategraphics[loop,autoplay,width=\linewidth]{10}{diagrams/shadow/fnum}{1}{15}
