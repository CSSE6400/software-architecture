...
\note[itemize]{
    ...
    \item Largely thanks to virtualization --- no physical activity for a new machine.
}
...
\point[The \textsl{main} difference]{Imperative vs. declarative}

\note{IC is heading towards a more declarative paradigm.}
...
\begin{itemize}[<+->]
    ...
    \item Tendancy to be \highlight{declarative}.
\end{itemize}
}
...
\point[Everything as code avoids]{
Configuration drift
}

\point[Configuration drift creates]{
Snowflakes
}
...
\point[Good Coding Practice \#4]{Code Reuse}
...
\note[itemize]{
    ...
    \item Unit testing relies of isolated testing.
    \item But\dots isolated testing doesn't make \textsl{much} sense for IaC.
}
