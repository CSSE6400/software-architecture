...
\titlegraphic {
    ...
    \node[left=0.1cm] at (current page.-9){
        \href{https://xkcd.com/2347/}{\includegraphics[width=4.75cm]{./dependency.png}}
    };
    \end{tikzpicture}
}
...
\Large{
\begin{itemize}
    \item \highlight{Functional Requirements} -- Functional features to be delivered.
    \item \highlight{Constraints} -- Real world constraints on development.
    \item \highlight{Principles} -- Ideas adopted to encourage design consistency.
    \item \highlight{Quality Attributes} -- Quality of service and cross-cutting concerns.
\end{itemize}
}
...
\begin{itemize}
    ...
    \item Technology
    \begin{itemize}
        \large{\item[$\bullet$] Iteroperability with existing systems}
...
\Large{Non-functional requirements for the success of software.}
...
\point[Dave Thomas]{Big design up front is dumb.\\Doing no design up front is even dumber.}
