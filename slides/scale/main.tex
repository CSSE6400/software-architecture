...
\begin{frame}[fragile]
\footnotesize
\only<1>{\codefile[language=terraform,linerange={1-3,16}]{hello-server.tf}{resources/hello-server.tf}}
\only<2>{\codefile[language=terraform,linerange={1-5,16}]{hello-server.tf}{resources/hello-server.tf}}
\only<3>{\codefile[language=bash]{setup.sh}{resources/setup.sh}}
\only<4>{\codefile[language=terraform,linerange={1-11,16}]{hello-server.tf}{resources/hello-server.tf}}
\only<5>{\codefile[language=terraform,linerange={1-16}]{hello-server.tf}{resources/hello-server.tf}}
\end{frame}
...
\only<2>{\codefile[language=terraform,linerange={1-17}]{hello-scale.tf}{resources/hello-scale.tf}}
\end{frame}
...
\footnotesize
\only<1>{\codefile[language=terraform,linerange={19-23,31-31}]{hello-scale.tf}{resources/hello-scale.tf}}
\end{frame}
...
\footnotesize
\only<1>{\codefile[language=terraform,linerange={19-31}]{hello-scale.tf}{resources/hello-scale.tf}}
\end{frame}
...
\footnotesize
\only<1>{\codefile[language=terraform,linerange={33-38}]{hello-scale.tf}{resources/hello-scale.tf}}
\end{frame}
...
\footnotesize
\only<1>{\codefile[language=terraform,linerange={40-53}]{hello-scale.tf}{resources/hello-scale.tf}}
\end{frame}
...
\footnotesize
\only<1>{\codefile[language=terraform,linerange={55-64}]{hello-scale.tf}{resources/hello-scale.tf}}
\end{frame}
