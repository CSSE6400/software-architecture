...
\end{frame}
\note{
    Emphasise the \highlight{real} advantage of Broker is low coupling and slightly easier extensibility.
}
...
\note[itemize]{
    ...
    \begin{itemize}
        \item \large Broker can handle a slightly higher load
        \item \large Broker is slightly easier to scale    
    \end{itemize}
    \vspace{0.4em}
    \item Mediator has more internal processing, so requires greater resources
}
