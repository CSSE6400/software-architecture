...
\begin{frame}{Coarse Services}
    ...
    {\LARGE
    \begin{itemize}
        \item Domains are large, coarse-grained services
        \item Each service will have an internal architecture
        \item Technical or domain partitioning may be done internally
    \end{itemize}
    }
\end{frame}
...
\note[itemize]{
    ...
    \item Point out that this require \& REST require stateless services.
}
