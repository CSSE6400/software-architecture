...
\note{Introduce idea of distributed systems and then move on to service-based being a simple approach.}
...
%        \centering
        \includegraphics[trim=195 197 850 195,clip,width=0.73\paperwidth]{../../notes/service-based/diagrams/separate-uis.png}
    \end{adjustwidth}
\end{frame}
\note[itemize]{
...
\begin{frame}{Separate UIs}
    \begin{adjustwidth}{-15mm}{-15mm}
        \centering
        \includegraphics[trim=197 197 197 197,clip,width=0.98\paperwidth]{../../notes/service-based/diagrams/separate-uis.png}
    \end{adjustwidth}
\end{frame}
\note[itemize]{
    \item UI Platform could be desktop, web or mobile app.
...
\note[itemize]{
    ...
    \item Inventory app is example of completely separate UI delivery a different app.
}
...
\end{frame}
\note[itemize]{
    \item \textbf{Reverse proxy} hides internal network structure of architecture.
    ...
    \item \textbf{Gateway} adds ``intelligence'' to the reverse proxy.
