...
\note[itemize]{
    \item Summarise Façade Design Pattern and how it is used in a service-based architecture
...
\note[itemize]{
    ...
    \vspace{0.3em}
    \item Examples of fulfilment, and inventory management activities
    \begin{itemize}
    	\Large
	    \item Customer's tracking order, staff generating pick lists and packaging details
	    \item Generate reports on stock levels and product popularity. Ordering new stock.
    \end{itemize}
}
...
\note[itemize]{
    ...
    \item Inventory app is example of completely separate UI delivering a different app
}
