...
\todo{Slide to introduce domain services for Sahara example.}
...
\begin{frame}{Sahara: Product Browsing Component Diagram}
    \begin{adjustwidth}{-10mm}{-10mm}
        \centering
        \includegraphics[trim=190 240 230 200,clip,width=0.97\paperwidth]{diagrams/sahara-component-browse.png}
    \end{adjustwidth}
\end{frame}
\note[itemize]{
...
\todo{REST API for Product Browsing?}
...
Comment about Services being domain partitioning, but Service internals may be technical or domain paritioned.
}
