...
\note{Emphasising idea that pipeline architecture is a layered architecture taken to an extreme,
...
\only<3->{
    ...
    \huge Flow of data between filters
}
\end{frame}
...
\note{Consequence: Pipeline architectures do not suit interactivity}
...
\note{Follows from independent filters}


\corollary{Composable Filters}{Filters (i.e. \highlight{Transformers} \& \highlight{Testers}) can be applied in any order}
\note[itemize]{
    \item Follows from independent filters
