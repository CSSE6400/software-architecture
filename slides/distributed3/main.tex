...
\note[itemize]{
    ...
    \item Termination enforces fault tolerance, requires progress is made towards a solution
}
...
\begin{frame}{Distributed Systems Node Failure Assumptions}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
        \end{itemize}
        		\note<3>{Nodes may send faulty or malicious messages.}
    \end{itemize}
    }
\end{frame}
...
\begin{itemize}
    ...
    \begin{itemize}
        \LARGE\item Prove correctness of concurrent and distributed systems
    \end{itemize}
\end{itemize}
}
