...
\point[\huge{AI}]{
    ...
    \Large
    \begin{itemize}
        \item Great tool for producing code
    			\begin{itemize}
       			\large{\item \highlight{Accuracy} is not so great}
    			\end{itemize}
        \item \highlight{Hallucinates} about details of API spec
        \vspace{2mm}
        \item Attempts to \highlight{rewrite} Learner Lab or UQ security policies
    			\begin{itemize}
       			\large{\item \highlight{Breaking} test runner}
    			\end{itemize}
        \vspace{2mm}
        \item Describe how you use AI in assignments
    			\begin{itemize}
       			\large{\item Include logs of AI tool history}
    			\end{itemize}
    \end{itemize}
}
