...
\textbf{Depth\newline30\%} &
Comprehensive, critical analysis of the architecture, addressing key strengths, weaknesses, and how well it meets the ASRs and quality attributes. The critique is insightful, balanced, and well-supported by evidence.&
Thorough and clear analysis of the architecture's strengths, weaknesses,~and how it addresses~ASRs and quality attributes. Some evidence~supports the critique. &
...
\textbf{Comparison\newline30\%} &
Highly detailed and insightful comparison of the chosen architecture and alternative, covering key dimensions. Clearly explains which architecture is more suitable and why. &
...
Strong analysis of trade-offs, with a clear explanation~of how the alternative would affect the system's quality attributes.	&
...
No trade-off analysis is provided, or it is inadequate or unsubstantiated. \\
\hline
