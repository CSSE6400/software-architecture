...
\item Imagine that you have to integrate \link{TurnItIn's academic integrity suite}
      ...
      \link{feedback studio}{https://www.turnitin.com.au/products/feedback-studio/},
      and \link{originality}{https://www.turnitin.com.au/products/feedback-studio/originality/}
...
UQ's Single Sign-On (SSO) uses \link{SAML authentication}{https://auth0.com/blog/how-saml-authentication-works/},
...
You can use the \link{Structurizr vNext Docker image}{https://hub.docker.com/r/structurizr/structurizr}
to generate your C4 diagrams during this case study session.
Once Structurizr is running, open \url{http://localhost:8080/} to view your diagrams.

\begin{figure}[h!]
\centering
\includegraphics[width=0.93\textwidth]{images/context}
...
\centering
\includegraphics[width=0.96\paperwidth]{images/container}
...
\centering
\includegraphics[width=0.99\paperwidth]{images/deployment}
