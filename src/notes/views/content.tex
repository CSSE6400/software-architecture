...
\section{C4 Model}
Simon Brown's C4 model provides a set of abstractions that describe the static structure of the software architecture \cite{brown2026c4}.
...
\begin{figure}[h!]
    \centering
    \begin{adjustwidth}{-7.5mm}{-7.5mm}
        \includegraphics[trim=193 90 195 198,clip,width=0.95\paperwidth]{images/c4/deployment_diagram.png}
    \end{adjustwidth}
...
The ``\texttt{x1..N}'' inside the web and application server deployment nodes
indicate that there will be at least one of each of these servers to share the load.
The application backend runs on Ubuntu servers, providing the core business logic shared by the web and mobile applications.
...
\begin{figure}[h!]
    \centering
    \begin{adjustwidth}{-7.5mm}{-7.5mm}
        \includegraphics[trim=25 195 14 25,clip,width=0.95\paperwidth]{images/c4/deployment_diagram-key.png}
    \end{adjustwidth}
...
\end{description}
The 4+1 View Model came from Philippe's experience leading development of the Canadian air traffic control management system.
...
Development was done by a team of about 2500 developers from two large consulting companies.
