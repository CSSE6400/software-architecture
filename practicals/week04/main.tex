...
\begin{itemize}
    \item AWS Academy Learner Lab [\href{https://awsacademy.instructure.com/courses/110995}{110995}]
...
\begin{enumerate}
    ...
    \item The AWS Learner Lab provides access to an environment which will be used in these practicals to learn AWS. 
          A separate Learn Lab will be used to develop your Cloud Infrastructure assignment.
\end{enumerate}
...
\teacher{The Cloud Foundation course has a module (6) that covers EC2 in more depth. You should direct students to it after completing the Hextris example.}

\vspace{2mm}
\includegraphics[width=0.95\textwidth]{images/search-ec2}
\vspace{5mm}
...
\vspace{3mm}
\includegraphics[width=0.96\textwidth]{images/ec2-interface}
