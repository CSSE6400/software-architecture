...
\aside{We will just be looking at the learner lab today, please ask on the Slack if you need help using the supplementary AWS Academy courses.}
...
\notice{If you're having timeout issues,
...
\bibliography{regions,ours,books}
