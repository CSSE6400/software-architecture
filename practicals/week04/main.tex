...
Below is a sample of the configuration, try and use what you learnt in last week's practical to deploy the following Terraform.

\info{
  We have only included the RDS specific resources below.
}
