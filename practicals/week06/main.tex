...
\author{Millie Hughes, Anna Truffet, Brae Webb \& Richard Thomas}
...
\paragraph{Example 1} Early in my career, I, Millie Hughes, setup a multi-node Directory Server at UQ under the hostname of \texttt{ldap.uq.edu.au}.
