...
For our automated tests we would like you to change the version number from the \texttt{pyproject} so that it is \texttt{python = "\textasciicircum 3.8"}.
If you are running a version of python lower than this then please consider upgrading as it is end-of-life.}
