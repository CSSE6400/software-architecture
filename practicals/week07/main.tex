...
\begin{code}[language=python]{todo/views/routes.py}
...
\begin{code}[language=python]{todo/tasks/ical.py}
import os
...
\bash{pipenv install celery redis celery[sqs]}

The above will install the Celery core and Redis and SQS drivers for communication.
