...
He argues that no one reads large documents but not knowing the rationale behind architecturally important decisions
...
ADRs explain why decisions were made, informing design decisions that developer's make so their code will fit into the architecture.
...
so that they do not inadvertently make design decisions that result in breaking expectations about the software.
...
\link{GitHub Blog}{https://github.blog/engineering/why-write-adrs/} \cite{why-write-adrs}.
