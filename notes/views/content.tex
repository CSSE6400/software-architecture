...
(\textbf{Note}, for many web applications you would not show the customer's computer and browser in the deployment diagram.
They are only shown in this example because the \texttt{ProductAnimator} module is an important part of the overall application being developed.)
