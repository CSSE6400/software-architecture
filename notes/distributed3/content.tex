...
Even for small systems, some part will \textit{eventually} fail, so fault handling must be part of the design.
...
A coordination service, such as \link{etcd}{https://github.com/etcd-io/etcd},
...
Coordination services, such as \link{etcd}{https://github.com/etcd-io/etcd}, implement total order broadcast.
