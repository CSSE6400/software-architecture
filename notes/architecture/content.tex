...
Just \todo{when was this (I've just emailed Ian to ask)} years ago,
...
\todo{Fix the links to not be brae-centric}

You can view the planned outline for the course on the \link{course website}{https://csse4400.brae.dev/}.
All the course material can be found on \link{GitHub}{https://github.com/BraeWebb/software-architecture}.
