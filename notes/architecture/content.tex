...
the application will need to redesigned from scratch.
...
For example, if all of the organisations existing applications are running on the Google cloud platform,
...
If contractors can be hired, or training is available, that may reduce the overhead but the decision needs to be made based on the risks and benefits.
...
and to implement practices which ensure the quality attributes are achieved.
