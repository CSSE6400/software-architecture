...
You will be given a second \link{Learner Lab}{https://awsacademy.instructure.com/courses/152633}
to use for the assignment, so that you start with a fresh budget for the assignment.
