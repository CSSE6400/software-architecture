...
\link{load balancer}{https://www.cloudflare.com/en-gb/learning/performance/what-is-load-balancing/},
...
The API layer is a \link{reverse proxy}{https://www.cloudflare.com/en-gb/learning/cdn/glossary/reverse-proxy/}
or \link{gateway}{https://www.baeldung.com/cs/api-gateway-vs-reverse-proxy} that provides access to the services,
...
Service Oriented Architecture \link{(SOA)}{https://www.ibm.com/topics/soa} is an extension of service-based architecture.
