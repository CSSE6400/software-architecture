...
\todo{MapReduce needs to be motivated}
...
Eventually, open source tools were developed which also capitalised on the parallel nature of the pattern with Hadoop being the most popular.
...
\todo{Make clear that compilers knowledge is not required.}
