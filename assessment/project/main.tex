...
Now, as the capstone project, your team will be allocated a software system to deliver, and you are required to
\begin{itemize}
...
%    \item identify the primary quality attributes which would enable success of the project,
    ...
    \item implement the software system using that architecture,
    \item deploy the system to a cloud environment, and
    \item evaluate and report on the success of the project.
\end{itemize}

\noindent
The successful completion of the project will result in two deliverables, namely,
...
%    \item a proposal of a software project, the proposal must clearly indicate and prioritise two or three quality attributes most important to the project's success,
    ...
    \item a report which evaluates the success of the developed software relative to its key quality attributes.
\end{enumerate}
...
and will continue to look at more over the remainder of the semester.
...
%You have been allocated to a project based on interest you have indicated by voting on proposals
%and on your previous coursework experience.

Your team needs to perform the roles of software architect, developer, and operations team.
You should design the basic structure of the initial software architecture,
based on the scope and quality attributes of the proposal you have been given.
...
\link{Minimum Viable Product (MVP)}{https://www.agilealliance.org/glossary/mvp/}.
The MVP needs to implement a usable core of the system's functionality,
as described in the project proposal.
The MVP should demonstrate that the architecture could deliver the functionality of a more sophisticated and feature rich system.
The MVP also needs to allow the software architecture to be tested,
to determine if it can deliver the project's important quality attributes.
...
You will not explicitly lose marks for renegotiating scope,
unless the revised scope limits your ability to adequately test important quality attributes.
...
%This evaluation should be based on the proposal's evaluation plan,
%but should \textbf{\emph{not}} be limited to only what is in that plan.
...
\begin{description}
    ...
    \item[Critique] How well does the architecture support delivering a more sophisticated and feature rich system.
...
Your critique should discuss how well the architecture is suited to delivering a more sophisticated and feature rich system.
...
and argumentation to demonstrate how well the attribute is delivered.
...
Your final submission will be what is in the main branch of your repository at the due date of 15:00 on 8 June 2026.
...
If you find ideas, code fragments, or libraries from external sources (e.g. Stack Overflow),
...
Significant amounts of cited or acknowledged work from other sources, will be considered to be of no academic merit.

\subsection{AI Usage}
You are encouraged to use generative AI tools (e.g. Copilot) to help you write the source code for this project.
The expectation is that the software architecture and detailed design are your team's own work.

You \textbf{must} include, in the root directory of your repository, a file called \texttt{ai.md}.
...
We prompted ChatGPT with a description of our design
...
Unacknowledged use of generative AI tools, will be treated as not being your own work.
...
or briefly summarising how the architecture facilitates delivering some quality attributes.
...
\texttt{thanhthuy.dao@uq.edu.au}, \texttt{evan.hughes@uq.edu.au}, \texttt{zaidul.alam@uq.edu.au},
\texttt{vukhanhvy.ho@uq.edu.au}, \texttt{c.badman@uq.edu.au}, \\
\texttt{n.garg@uq.edu.au}, and all of your team members.
The video must remain available until \textbf{\textit{at least}} 31 July 2026.
...
The video may be in 1080p resolution.
There is no need for a 4K HDR video of your demonstration.

\begin{samepage}
The video  should be approximately as follows.

\begin{description}
    \item[2 min] Introduction to the project.
...
Briefly explain how well it supports delivery of the MVP's,
\textit{and} a more sophisticated and feature rich system's,
