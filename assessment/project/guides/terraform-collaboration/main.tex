...
Replace
\begin{itemize}
  \item \texttt{123456789012} with the AWS account ID from the shared AWS account allocated to your team for the project,
  \item \texttt{us-east-1} with the AWS region your team is using, and
