...
(e.g. It will find all copies of the Dune Ultra HD Bluray and aggregate them into a single trading set.)
...
\begin{enumerate}
	...
	\item If the active purchasing group wants more items than are available in the active sales group, all items in the active sales group are sold for their minimum sales price.
	...
	\item If the active purchasing group wants fewer, or the same number of, items than are available in the active sales group, items in the active sales group are sold for the active purchasing group's maximum purchase price.
\end{enumerate}
