...
\textbf{Important Note: AWS will deactivate your account if more than 15 EC2 instances are running. Ensure you do not exceed a total of 15 EC2 instances running at once.}
...
such as S3 from an EC2 instance.
...
\paragraph{EC2 Instance Size}
The chatterbox command line tool and dependencies are quite large.
You may find that the default 8GB size of an EC2 instance is insufficient.
You can use \link{the \texttt{block\_device\_mappings} field}%
{https://github.com/CSSE6400/terraform/blob/740edeb8eacb8b80f5d85a729fd3914b4d2a5b0f/template/main.tf\#L31} of \texttt{aws\_instance}
to create a volume with larger storage space.

\paragraph{URL Validity}
The URL returned from the API to access the audio file
