...
You are to deploy an API to analyse images of headshots to identify an individuals generation cohort.
...
\info{The scenario in this document is purely fictional for the assignment and does not represent the view or opinions of the authors.}
...
the analysis is able to identify percentage certainity of the given assets to their generational cohort with an estimated age approximation.
...
Automated tests provide faster responses with varying degree of certainity to allow manual review when its required.
...
The tool has varying performance, due to the difficulty of identifiy cohorts.
...
Your Github repository should look similar to the following at minimum:
